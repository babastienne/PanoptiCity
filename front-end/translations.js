let translatedTexts = {
  en: {
    ...
    cameraDirectionQuestion:
      "Indicate on the map the direction where the camera is pointed",
    ...
    cameraHeightQuestion: "What is the height of the camera (in m) ?",
    cameraAngleQuestion: "What is the angle of the camera ?",
  },
  fr: {
    ...
    cameraDirectionQuestion:
      "Indiquez sur la carte la direction vers laquelle la caméra est dirigée",
    ...
    cameraHeightQuestion: "Quelle est la hauteur de la caméra (en m) ?",
    cameraAngleQuestion: "Quel est l'angle de la caméra ?",
  },
};
