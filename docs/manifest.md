...
This argument is so common that there is a [dedicated wikipedia page](https://en.wikipedia.org/wiki/Nothing_to_hide_argument) about it.
...
With technologies and surveillance, the argument to make it acceptable is always one that cannot be objected: fighting terrorism for CCTV, finding pedophiles for [chat control](https://fightchatcontrol.eu/), etc. In the end it always expands and is used against the population.
...
- [Amnesty International: Ban the scan](https://banthescan.amnesty.org/index.html)
- [Privacy International](https://privacyinternational.org/learn/mass-surveillance)
